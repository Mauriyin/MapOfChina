...
using System.IO;
public class button27 : MonoBehaviour{
	private bool flag;
	...
	void OnGUI(){
		if (flag){
			GUI.Box(new Rect(800, 20, 200, 150), "陕西省",font);
			GUILayout.BeginArea(new Rect(800, 50, 200, 200));
			GUILayout.Label("省会：西安市");
			GUILayout.Label("区号：029");
			GUILayout.Label("人口：3732.74万人");
			GUILayout.EndArea();
		}
	}
}